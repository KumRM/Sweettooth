...
<h2 align="center">
<p style="font-size: smaller; color: #823f3f;">Product Registration Form</p>
</h2>
</div>
...
<tr>
<td>
<input type="button" class="btn btn-warning" ng-click="sortType='productId'; sortReverse = !sortReverse" value="PRODUCT ID">
...
<td>
<input type="button" class="btn btn-warning" ng-click="sortType='productName'; sortReverse = !sortReverse" value="PRODUCT NAME">
...
<td>
<input type="button" class="btn btn-warning" ng-click="sortType='productDescription'; sortReverse = !sortReverse" value="PRODUCT DESCRIPTION">
...
<td>
<input type="button" class="btn btn-warning" ng-click="sortType='productQuantity'; sortReverse = !sortReverse" value="PRODUCT QUANTITY">
...
<td>
<input type="button" class="btn btn-warning" ng-click="sortType='productDiscount'; sortReverse = !sortReverse" value="PRODUCT DISCOUNT">
...
<td>
<input type="button" class="btn btn-warning" ng-click="sortType='productPrice'; sortReverse = !sortReverse" value="PRODUCT PRICE">
